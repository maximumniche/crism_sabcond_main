...
crism_convolve_hitran_abscoef('4774','Columns',55, ...
...
crism_obs_ref = CRISMObservation('4774','SENSOR_ID','L');
...
crism_convolve_hitran_abscoef('4774', ...
    'ABSCOEF_DIR', '/home/imadk/Documents/MATLAB/CRISM/HITRAN/mars_hitran', 'mcd_ver', '6_1');

%%
crism_obs_ref = CRISMObservation('4774','SENSOR_ID','L');
TRRIFdata_ref = CRISMdata(crism_obs_ref.info.basenameIF,'');
[out_bland2] = sabcondv5_pub('4774', ...
...
c=574;
[out_t1c] = sabcondv5_pub_column_test('47A3', c, ...
    'FFC_MODE',false,'FFC_IF_COUNTER',1,...'LINES',100:200,...
    'WEIGHT_MODE',1,'cal_bias_cor',0,...
...
[out_tar] = sabcondv5_pub('47A3', ...
    ...
    'lambda_update_rule','L1SUM',...
    'SAVE_FILE',false,...
    'SAVE_FILE',true, 'additional_suffix', 'mcd6_1s01_47A3',...
    'save_pdir','/home/imadk/data/results',...
    'T_UPDATE', 2, 'logT_neg', false, 'opt_bands_ignore_init', 'none', ...
    'include_ice', true);
