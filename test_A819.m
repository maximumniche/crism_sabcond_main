...
crism_convolve_hitran_abscoef('A841','Columns',55, ...
    'ABSCOEF_DIR', '/home/imadk/Documents/MATLAB/CRISM/HITRAN/mars_hitran', 'mcd_ver', '6_1', ...
...
crism_obs_ref = CRISMObservation('A841','SENSOR_ID','L');
TRRIFdata_ref = CRISMdata(crism_obs_ref.info.basenameIF,'');
[out_t1c] = sabcondv5_pub_column_test('A841', 55, ...
...
crism_convolve_hitran_abscoef('A841', ...
    'ABSCOEF_DIR', '/home/imadk/Documents/MATLAB/CRISM/HITRAN/mars_hitran', 'mcd_ver', '6_1', 'H2O_SCALE', '1.0');

%%
crism_obs_ref = CRISMObservation('A841','SENSOR_ID','L');
TRRIFdata_ref = CRISMdata(crism_obs_ref.info.basenameIF,'');
[out_bland2] = sabcondv5_pub('A841', ...
    ...
    'Library_opt', 'full', ...
    'OPT_CRISMSPCLIB',0, 'OPT_RELAB', 0, 'OPT_CRISMTYPELIB', 0, ...
    'OPT_SPLIBUSGS', 0, 'OPT_ICELIB', 9, 'OPT_SURFICELIB', 1, ...
    ...
    'nIter', 2, 'Bands_Opt', 6,...
    'PRECISION', 'double', 'PROC_MODE', 'CPU_2',...
    'debug', false,...
    ...
    'save_pdir','/home/imadk/data/results',...
    'T_UPDATE', 2, 'logT_neg', false, 'opt_bands_ignore_init', 'none', ...
    'include_ice', true);
...
fname = ['TList_' TRRIFdata_ref.basename out_bland2.settings.suffix ...
         '.mat'];
fpath = joinPath('/home/imadk/data/T',fname);
save(fpath,'TList');
%% check the results
obs_id = 'A841';
...
c=574;
[out_t1c] = sabcondv5_pub_column_test('A819', c, ...
    'FFC_MODE',false,'FFC_IF_COUNTER',1,...'LINES',100:200,...
    'WEIGHT_MODE',1,'cal_bias_cor',0,...
...
[out_tar] = sabcondv5_pub('A819', ...
    ...
    'Library_opt','full', ...
    'OPT_CRISMSPCLIB',1, 'OPT_RELAB', 1, 'OPT_CRISMTYPELIB', 4, ...
    'OPT_SPLIBUSGS',6, 'OPT_ICELIB', 9, 'OPT_SURFICELIB', 1, ...
    ...
    'PRECISION','double','PROC_MODE','CPU_2',...
    'debug', false, ...'DEBUG_L_PLOT',l,...
    'lambda_update_rule','L1SUM',...
    'SAVE_FILE',false,...
    'SAVE_FILE',true, 'additional_suffix', 'mcd6_1s01_A819',...
    'save_pdir','/home/imadk/data/results',...
    'T_UPDATE', 2, 'logT_neg', false, 'opt_bands_ignore_init', 'none', ...
    'include_ice', true);
